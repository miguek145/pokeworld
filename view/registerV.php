        ...
        <section class="contenedorFormularioRegistroLogin">
                ...
                <form action="" method="post">
                    ...
                    <p>
                        ...
                        <p class="esconder smsError " >min 8 letters first Mayus atleast 1 number and 1 sepcial letter</p>
                    </p>
                    <label for="confirmPassword">CONFIRM PASSWORD:</label>
                    <p>
                        <input type="password" name="confirmPassword" id="confirmPassword" class="2"  required>
                        <p class="esconder smsError" id="mensajeContraseñasNoCoinciden">min 8 letters first Mayus atleast 1 number and 1 sepcial letter</p>
                    </p>
                    <label for="email">EMAIL:</label>
                    <p>
                        <input type="text" name="gmail" id="email" class="3" required autocomplete="off">
                        <p class="esconder smsError">gmail/htomail and .es/.com</p>
                    </p>
