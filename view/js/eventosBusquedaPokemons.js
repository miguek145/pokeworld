    ...
    botonVerMas.addEventListener("click",(ev)=>{
        ...
        $.ajax({
            ...
            error: function(textStatus,errorThrown) {
                ...
                contenedorTarjetasPokemon.innerHTML = "<p>ERROR TO GET POKEMONS</p>";
            }
        })
...
eventoBotonFilter();
eventoBotonViewMore();
eventoFiltroBusqueda();
eventoBuscadorNombrePokemon();
comprobarPokemonfavorito();