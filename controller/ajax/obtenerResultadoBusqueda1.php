<?php
    ...
    if(isset($_SESSION['usuario'])){
         //visualizar tabla pokemon por buscador nombre pokemon y que se viusaliven los iconos de alñadir a favoritos
     ...
     if(isset($arrayDatosPokemons)){
        ...
        //visualizamos la tabla de tarhjetas de pokemons
