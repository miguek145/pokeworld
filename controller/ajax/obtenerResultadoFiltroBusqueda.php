<?php
    ...
    session_start();
    //obtenemos los datos habitat y tipo del filstro de búsqueda
    $habitat= $_GET['datos'][0];
    $tipo=$_GET['datos'][1];
    ...
    if(isset($_SESSION['usuario'])){
        ...
        $arrayDatosPokemons=Pokemon::visualizarTablaPokemonDatosFiltro($habitat,$tipo,$_SESSION['usuario'],$_SESSION['tipoUsuario']);
    }else{
         //visualizar tabla pokemon
         $arrayDatosPokemons=Pokemon::visualizarTablaPokemonDatosFiltro($habitat,$tipo,"","");
    }
    ...
    if(isset($arrayDatosPokemons)){
        ...
        //visualizamos la nueva lista de tarjetas pokemon 
